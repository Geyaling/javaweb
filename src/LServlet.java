...
public class LServlet extends HttpServlet {
    public void doPost(HttpServletRequest request, HttpServletResponse response)
         ...
         * 2. 校验用户名和密码是否正确
         */
        if(!"root".equalsIgnoreCase(username)) {//登录成功
            /*
            ...
            response.sendRedirect("/JSP/jsp_session2/succ1.jsp");
        } else {//登录失败
            /*
             * 4. 如果失败
             *   > 保存错误信息到request域中
            ...
            RequestDispatcher qr = request.getRequestDispatcher("/jsp_login/index.jsp");//得到转发器
